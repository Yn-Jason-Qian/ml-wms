...
public class AreaRepositoryImpl implements AreaRepository {
    ...
    @Override
    public Optional<Area> findById(Long id) { return Optional.ofNullable(mapper.selectById(id)); }

    @Override
    public List<Area> findByWarehouse(Long tenantId, Long warehouseId) {
        return mapper.selectList(new LambdaQueryWrapper<Area>()
                .eq(Area::getTenantId, tenantId).eq(Area::getWarehouseId, warehouseId));
    }
    ...
    @Override public void save(Area area) { mapper.insert(area); }
    @Override public void update(Area area) { mapper.updateById(area); }
