...
public class SkuPackageRepositoryImpl implements SkuPackageRepository {
    ...
    @Override
    public Optional<SkuPackage> findById(Long id) {
    ...
    public List<SkuPackage> findBySkuId(Long tenantId, Long skuId) {
        return mapper.selectList(
                new LambdaQueryWrapper<SkuPackage>()
                        .eq(SkuPackage::getTenantId, tenantId)
                        .eq(SkuPackage::getSkuId, skuId));
    }

    @Override
    public void save(SkuPackage pkg) {
        mapper.insert(pkg);
    }

    @Override
    public void update(SkuPackage pkg) {
        mapper.updateById(pkg);
    }
