...
/**
 * 批量生成库位命令 —— 按规则自动生成库位编码。
 * 例：warehouseId=1, areaId=2, warehousePrefix="WH01",
 *     aisleRange=1~3, shelfRange=1~5, tierRange=1~4, depthRange=1~2
 *     生成 3×5×4×2=120 个库位，编码如 WH01-01-01-01-01
 */
@Data
