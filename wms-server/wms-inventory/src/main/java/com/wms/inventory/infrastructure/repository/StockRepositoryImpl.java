...
public class StockRepositoryImpl implements StockRepository {
    ...
    @Override
    public Optional<Stock> findByKey(
            Long tenantId, Long warehouseId, Long locationId, Long skuId, String batchNo) {
        return Optional.ofNullable(
                mapper.findByKey(tenantId, warehouseId, locationId, skuId, batchNo));
    }
    ...
    @Override
    public int updateWithVersion(Stock stock) {
        return mapper.updateWithVersion(stock);
    }
}
