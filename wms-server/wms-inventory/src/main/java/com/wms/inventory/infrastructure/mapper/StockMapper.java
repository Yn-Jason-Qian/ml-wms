...
public interface StockMapper extends BaseMapper<Stock> {
    ...
    @Update("UPDATE wms_inventory_stock SET qty_on_hand = #{qtyOnHand}, " +
    ...
    /** 按唯一键查找库存 */
    @org.apache.ibatis.annotations.Select("SELECT * FROM wms_inventory_stock " +
    ...
    Stock findByKey(@Param("tenantId")Long tenantId,
