...
public class StrategyAssembler {
    ...
    public StrategyConfig toEntity(StrategyConfigCreateCmd cmd) {
        ...
        c.setStrategyCode(cmd.getStrategyCode());
        c.setStrategyName(cmd.getStrategyName());
        c.setStrategyType(cmd.getStrategyType());
    ...
    public StrategyConfigDTO toDTO(StrategyConfig c, java.util.List<StrategyRule> rules) {
        ...
        d.setId(c.getId());
        d.setStrategyCode(c.getStrategyCode());
        d.setStrategyName(c.getStrategyName());
        d.setStrategyType(c.getStrategyType());
        d.setDescription(c.getDescription());
        d.setSortOrder(c.getSortOrder());
        d.setIsEnabled(c.getIsEnabled());
    ...
    public StrategyRule toEntity(StrategyRuleCreateCmd cmd) {
        ...
        r.setStrategyId(cmd.getStrategyId());
    ...
    public StrategyRuleDTO toDTO(StrategyRule r) {
        ...
        d.setId(r.getId());
        d.setStrategyId(r.getStrategyId());
        d.setRuleNo(r.getRuleNo());
        d.setRuleName(r.getRuleName());
        d.setConditionsJson(r.getConditionsJson());
        d.setActionsJson(r.getActionsJson());
